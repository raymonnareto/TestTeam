...
If Not DataTable("StoreOpen", "TestLogs") = "N" Then
	OpenStoreLogging(DataTable("StoreOpen", "TestLogs"), DataTable("[Act]StoreOpen", "TestLogs"), DataTable("[Exp]StoreOpen", "TestLogs"), 0)
End If
...
If Not DataTable("StoreOpen", "TestLogs") = "N" Then
	OpenStoreLogging(DataTable("StoreOpen", "TestLogs"), DataTable("[Act]StoreOpen", "TestLogs"), DataTable("[Exp]StoreOpen", "TestLogs"), 1)
End If
...
If Not DataTable("StoreOpen", "TestLogs") = "N" Then
	OpenStoreLogging(DataTable("StoreOpen", "TestLogs"), DataTable("[Act]StoreOpen", "TestLogs"), DataTable("[Exp]StoreOpen", "TestLogs"), 2)
End If
...
If Not DataTable("StoreOpen", "TestLogs") = "N" Then
   OpenStoreLogging(DataTable("StoreOpen", "TestLogs"), DataTable("[Act]StoreOpen", "TestLogs"), DataTable("[Exp]StoreOpen", "TestLogs"), 3)
End If
...
If Not DataTable("StoreOpen", "TestLogs") = "N" Then
   OpenStoreLogging(DataTable("StoreOpen", "TestLogs"), DataTable("[Act]StoreOpen", "TestLogs"), DataTable("[Exp]StoreOpen", "TestLogs"), 4)
End If
...
If Not DataTable("StoreOpen", "TestLogs") = "N" Then
   OpenStoreLogging(DataTable("StoreOpen", "TestLogs"), DataTable("[Act]StoreOpen", "TestLogs"), DataTable("[Exp]StoreOpen", "TestLogs"), 5)
End If
